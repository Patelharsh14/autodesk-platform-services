...
// Function to get the Autodesk authorization URL
...
// Middleware to handle the OAuth callback and store tokens in session
service.authCallbackMiddleware = async (req, res, next) => {
  ...
  // Middleware to refresh the token if it's expired
...
// Get users of a specific project
...
// ACC Admin APIs - add more functions as needed
...
// Import users to a specific project
